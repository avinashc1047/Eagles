...
public partial class EaglesOracleContext : DbContext
{
    ...
    public virtual DbSet<InventoryState> InventoryState { get; set; }
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        modelBuilder.Entity<Inventory>(entity =>
        {
            ...
            entity.HasOne(d => d.InventoryProduct).WithMany(p => p.Inventory)
                .OnDelete(DeleteBehavior.ClientSetNull)
        ...
        modelBuilder.Entity<InventoryState>(entity =>
        {
            ...
            entity.HasOne(d => d.InventoryStateInventory).WithMany(p => p.InventoryState)
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("INVENTORY_STATE_FK2");

            entity.HasOne(d => d.InventoryStateInventoryStatus).WithMany(p => p.InventoryState)
                .OnDelete(DeleteBehavior.ClientSetNull)
        ...
        modelBuilder.Entity<OrdersLine>(entity =>
        {
            ...
            entity.HasOne(d => d.OrdersLineInventory).WithMany(p => p.OrdersLine)
                .OnDelete(DeleteBehavior.ClientSetNull)
